...
class AdbKeyPair {
  ...
  /// 验证生成的RSA密钥对质量
  static bool _validateGeneratedKeyPair(RSAPrivateKey privateKey, RSAPublicKey publicKey) {
    try {
      if (privateKey.modulus == null || privateKey.privateExponent == null ||
          publicKey.modulus == null || publicKey.exponent == null) {
        return false;
      }
      ...
      if (privateExponent <= BigInt.one || privateExponent == publicKey.exponent) {
        return false;
      }
